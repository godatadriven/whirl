...
pip install --disable-pip-version-check --progress-bar=raw --no-cache-dir pyspark==${SPARK_VERSION}
pip install --disable-pip-version-check --progress-bar=raw --no-cache-dir apache-airflow-providers-apache-spark
